...
ipv4 cant be disabled even when 6 is enables 
dual stack mode works alongs side ivp6 and 4 

both a internal private ivp4 and a public 6 which is interet rouytable (though gateway )

usefull for enviremnets that are moving to ipv6 but still need ipv4 .
